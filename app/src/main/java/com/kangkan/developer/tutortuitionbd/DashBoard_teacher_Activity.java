...
public class DashBoard_teacher_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    startActivity(new Intent(DashBoard_teacher_Activity.this,Log_In_Activity.class));
                    finish();
                }
            }
        });
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                Toast.makeText(DashBoard_teacher_Activity.this, "DB Error", Toast.LENGTH_LONG).show();
