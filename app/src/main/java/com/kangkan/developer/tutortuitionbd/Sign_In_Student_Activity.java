...
public class Sign_In_Student_Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void registerUser() {
        ...
        if (FilePathUri != null) {
            ...
            storageReference2nd.putFile(FilePathUri)
                                    ...
                                    .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                        ...
                                        public void onComplete(@NonNull Task<AuthResult> task) {
                                            ...
                                            if (task.isSuccessful()) {
                                                ...
                                                FirebaseDatabase.getInstance().getReference("Student")
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        ...
                                                        if (task.isSuccessful()) {
                                                            ...
                                                            Toast.makeText(Sign_In_Student_Activity.this, getString(R.string.app_name), Toast.LENGTH_LONG).show();
                                                            Intent intent=new Intent(Sign_In_Student_Activity.this,DashBoard_student_Activity.class);
                                                ...
                                                Toast.makeText(Sign_In_Student_Activity.this, task.getException().getMessage(), Toast.LENGTH_LONG).show();
                                                button.setVisibility(View.VISIBLE);
                                            }
                                        }
                                    });
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception exception) {
                            ...
                            Toast.makeText(Sign_In_Student_Activity.this, exception.getMessage(), Toast.LENGTH_LONG).show();
                            progressBar.setVisibility(View.GONE);
                            button.setVisibility(View.VISIBLE);
                        }
                    })
            ...
            Toast.makeText(Sign_In_Student_Activity.this, "Please Select Image", Toast.LENGTH_LONG).show();
            progressBar.setVisibility(View.GONE);
            button.setVisibility(View.VISIBLE);
        }
